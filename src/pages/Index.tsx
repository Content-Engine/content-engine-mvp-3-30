      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Streamline your content creation workflow with powerful analytics and collaborative tools.
          </p>
          ...
          <Card className="glass-card">
            ...
            <CardContent>
              <p className="text-white/70">
                Collaborative tools for teams with tailored dashboards for different workflows.
              </p>
            </CardContent>
          </Card>
